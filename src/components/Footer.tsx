          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="max-w-md">
              ...
              <p className="text-sm text-slate-700 mt-1.5 leading-relaxed">
                Join the waitlist — be first to know when Sajilo Renew goes
                live.
              </p>
            </div>
            <form
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6">
          ...
          <div className="sm:col-span-2 lg:col-span-4 lg:pr-6">
            ...
            >
              ...
              <span className="bg-linear-to-r from-green-700 to-blue-800 bg-clip-text text-transparent font-bold text-xl">
                Sajilo Renew
              </span>
            </Link>
            <p className="text-sm text-slate-700 leading-relaxed max-w-xs mb-5">
              Nepal's upcoming #1 vehicle renewal, property tax, and document
              expiry reminder platform. Launching&nbsp;soon!
            </p>
              ...
              {[
                {
                  ...
                  href: "https://www.facebook.com/profile.php?id=61590066971096",
                },
                {
                  label: "LinkedIn",
                ...
                {
                  label: "Instagram",
                  path: "M7.75 2h8.5A5.75 5.75 0 0122 7.75v8.5A5.75 5.75 0 0116.25 22h-8.5A5.75 5.75 0 012 16.25v-8.5A5.75 5.75 0 017.75 2zm0 1.5A4.25 4.25 0 003.5 7.75v8.5A4.25 4.25 0 007.75 20.5h8.5a4.25 4.25 0 004.25-4.25v-8.5A4.25 4.25 0 0016.25 3.5h-8.5zm8.875 2.125a.875.875 0 11-1.75 0 .875.875 0 011.75 0zM12 7a5 5 0 110 10 5 5 0 010-10zm0 1.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7z",
                  href: "https://www.instagram.com/sajilo_renew/",
                },
                {
                  label: "TikTok",
                  href: "https://www.tiktok.com/@sajilo.renew",
                  path: "M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.08 2.67 1.67 4.25 1.84v4.03c-1.46-.05-2.89-.35-4.22-.89-.58-.24-1.12-.54-1.65-.88-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.78-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.17-4.03 0-7.29-3.26-7.29-7.29 0-4.03 3.26-7.29 7.29-7.29.31 0 .61.02.91.06v4.07a3.2 3.2 0 00-.91-.13 3.22 3.22 0 103.22 3.22V.02z",
                },
              ].map((social, i) => (
                <a
                  key={i}
                  ...
                  className="w-9 h-9 rounded-lg bg-white/15 border border-white/25 hover:bg-white/25 hover:border-white/40 flex items-center justify-center transition-all duration-200"
                >
                  <svg
          ...
          {linkSections.map((section) => (
            <div key={section.id} className="lg:col-span-2">
              ...
              >
                ...
                <ChevronDown
                  className={`w-4 h-4 text-slate-700 transition-transform duration-200 ${openSection === section.id ? "rotate-180" : ""}`}
                />
              </button>
          ...
          <div className="lg:col-span-4">
            ...
            >
              ...
              <ChevronDown
                className={`w-4 h-4 text-slate-700 transition-transform duration-200 ${openSection === "contact" ? "rotate-180" : ""}`}
              />
            </button>
            <h3 className="hidden sm:block text-xs font-semibold text-slate-700 uppercase tracking-[0.15em] mb-4">
              Contact Us
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-800">
                      info@sajilorenew.com
                    </p>
                  </div>
                </li>
              </ul>
              <p className="text-[11px] text-slate-600 uppercase tracking-wider font-medium mb-2.5">
                Coming soon on
              </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-xs text-slate-600 order-2 sm:order-1">
              © {new Date().getFullYear()} Sajilo Renew Pvt. Ltd. All rights
              reserved.
            </p>
